...
def DownloaderClass(url,dest):
    ...
    dp.create("Halow TV","Downloading Latest TV List")
...
#	repoCheck.UpdateRepo()
	AddDir("[COLOR red][B]HALOW TV FREE [/B][/COLOR]", "Update" ,99 ,"http://images.clipartpanda.com/arrow-20clip-20art-arrows_green_red.png")	
